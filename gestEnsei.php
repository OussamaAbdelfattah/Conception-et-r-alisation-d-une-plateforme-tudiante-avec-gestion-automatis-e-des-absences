<?php
    ...
    include_once "php/conn.php";
        ...
        if (isset($_POST['Ajouter'])) {
            ...
            $sql3 = "INSERT INTO Personne (nom, prenom, type, adresse, tele1) VALUES('$nom', '$prenom', 'Prof', '$adresse', '$tele1');";
                            ...
                            <div class="content-frame">
                                ...
                                <div class="content-frame-top">
                                    <div class="page-title">
                                        <h2><span></span>Gestion des Enseignants</h2>
                                    </div>
                                ...
                                <div class="row" id="monFormulaire" style="margin-left: 60px; display: none;">
                                    <form method="post"  name="form">
                                        ...
                                        <legend
                                        class="scheduler-border">Modifier Enseignant</legend>
                                            <div>
                                                <table align="center">
                                                    <tr>
                                        ...
                                        <table 
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        ...
                                                        Telephone 2</th> -->
                                                        <th class="sorting_disable" tabindex="0" aria-controls="table_retards_etudiant" rowspan="1" colspan="1" aria-label="Heure fin: activate to sort column ascending" style="width: 169px;">
                                                            Action</th>
