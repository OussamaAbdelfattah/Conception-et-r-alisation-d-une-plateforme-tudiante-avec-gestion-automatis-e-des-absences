<?php
    ...
    include_once "php/conn.php";
        $sql1 = "SELECT s.id_salle, s.nom, l.id_lecteur FROM Salle s, Lecteur_RFID l WHERE s.id_salle = l.id_salle;";
        ...
        while($row1 = $result1->fetch_assoc()){
            ...
            $lignesHTML .= "<tr>
                                <td><span class='editable' id='idsalle-$id'>$id</span></td>
                                <td><span class='editable' id='nom-$id'>$nom</span></td>
                                <td><span class='editable' id='idlecteur-$id'>$idL</span></td>
                                <td>
                                    <form method='post'>
        ...
        if (isset($_POST['Ajouter'])) {
            ...
            $sql5 = "INSERT INTO Salle (nom) VALUES('$nom');";
        ...
        if (isset($_POST['modifier'])) {
            ...
            // echo "UPDATE Salle SET nom = '$nom' WHERE id_salle = $idsalle;";
            // var_dump($_POST);
            $sql2 = "UPDATE Salle SET nom = '$nom' WHERE id_salle = $idsalle;";
        ...
        if (isset($_POST['supp'])){
            $idd = $_POST['supp'];
            $sql = "DELETE FROM Salle WHERE id_salle=$idd";
		    ...
		    if( msg == 1 ){
			 ...
			 return false;
                            ...
                            <ul class="breadcrumb push-down-0">
                                ...
                                <li class="active">Gestion des Salles</li>
                            </ul>
                            ...
                            <div class="content-frame">
                                ...
                                <div class="content-frame-top">
                                    <div class="page-title">
                                        <h2><span></span>Gestion des Salles</h2>
                                    </div>
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <input type="button"
                                                                ...
                                                                value="Rétablir" onclick="getElementById('nom').value = '';getElementById('idlecteur').value = '';
                                                                                            getElementById('idsalle').value = ''"/>
                                ...
                                <script>
                                    function toggleForm(event, id) {
                                        ...
                                        if (document.getElementById('monFormulaire').style.display == 'none' && id != -1) {
                                            ...
                                            document.getElementById("idsalle").style.display = 'block';
                                            document.getElementById("idlecteur").style.display = 'block';
                                            // console.log(id);
                                            ...
                                            idsalle = document.getElementById("idsalle-" + id).innerHTML;
                                            idlecteur = document.getElementById("idlecteur-" + id).innerHTML;

                                            document.getElementById("nom").setAttribute("value", nom);
                                            document.getElementById("idsalle").setAttribute("value", idsalle);
                                            document.getElementById("idlecteur").setAttribute("value", idlecteur);

                                            document.getElementById("nom").setAttribute("placeholder", nom);
                                            document.getElementById("idsalle").setAttribute("placeholder", idsalle);
                                            document.getElementById("idlecteur").setAttribute("placeholder", idlecteur);
                                            ...
                                            document.getElementById("idsalle").style.display = 'none';
                                            document.getElementById("idlecteur").style.display = 'none';
                                        }else {
                                            document.getElementById('monFormulaire').style.display = 'none';
                                            document.getElementById("nom").setAttribute("value", "");
                                            document.getElementById("idsalle").setAttribute("value", "");
                                            document.getElementById("idlecteur").setAttribute("value", "");

                                            document.getElementById("nom").setAttribute("placeholder", "");
                                            document.getElementById("idsalle").setAttribute("placeholder", "");
                                            document.getElementById("idlecteur").setAttribute("placeholder", "");
                                        }
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        <th 
                                                            ...
                                                            style="width: 297px;" aria-sort="ascending">Id Salle
                                                        </th>
                                                        <th 
                                                        ...
                                                        <th 
                                                            ...
                                                            colspan="1"
                                                            aria-label="Type de la séance: activate to sort column descending" 
                                                            style="width: 297px;" aria-sort="ascending">Id Lecteur
                                                        </th>
                                                        <!-- <th 
                                                            class="sorting" tabindex="0" 
                                                            aria-controls="table_retards_etudiant" 
