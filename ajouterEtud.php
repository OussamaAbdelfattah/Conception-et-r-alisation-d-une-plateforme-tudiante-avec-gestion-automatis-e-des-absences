                ...
                <ul class="x-navigation">
                    ...
                    <li>
                        ...
                        <ul style="display: block;">
                            ...
                            <li><a href="#"><i class="fa fa-trash"></i>Supprimer des étudiants</a></li>
                    ...
                    <li>
                        ...
                        <ul style="display: block;">
                            <li><a href="#"><i class="fa fa-university"></i> Gérer les salles de classe et les laboratoires</a></li>
                            <!-- Sous-rubrique RFID -->
                            <li>
                                <a href="#" class="toggle-submenu">
                            ...
                            <div class="content-frame">
                                ...
                                <div class="content-frame-top">
                                    <div class="page-title">
                                        <h2><span></span>Ajouter étudiant</h2>
                                    </div>
                                ...
                                <form method="post" id="formMdp" name="formMdp">
                                    ...
                                    <fieldset class="scheduler-border col-md-8">
                                        <legend
                                            class="scheduler-border">Ajouter étudiant</legend>
                                        <div>
                                            <table align="center">
                                                <tr>
