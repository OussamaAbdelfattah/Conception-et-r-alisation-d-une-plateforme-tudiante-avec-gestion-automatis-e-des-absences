<?php
    ...
    if(isset($_SESSION['email']) && isset($_SESSION['pwd'])){
        ...
        if(empty($row1)){
            ...
            $retard = calculerTotalHeures($row1['count']);
        }
        //deuxieme requete 
        $sql2 = "SELECT sc.type_seance, Mt.nom as nomMatiere, ps.date_presence, sc.heure_debut, sc.heure_fin
                ...
                <ul class="x-navigation">
                    ...
                    <li><a
                            href="<?php echo "retards.php"; ?>"><span
                                ...
                                retards</span></a></li>
                    <!-- javascript:chargerPage( 'releveAbsencesEtudiant') -->
                    <li><a
            ...
            <head>
                ...
                <html lang="en">
                    <body>
                        <div class="page-container">
                            ...
                            <ul class="breadcrumb push-down-0">
                                ...
                                <li class="active">Relevé des retards</li>
                            </ul>
                            ...
                            <div class="content-frame">
                                ...
                                <div class="content-frame-top">
                                    <div class="page-title">
                                        <h2><span></span>Relevé des retards</h2>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div class="col-md-12" id="links">
                                        ...
                                        <div id="Justifies_r">
                                            <p>Justifiés : <?php echo $retard;?></p>
                                        </div>
                                        <div id="Non_justifies_r">
                                            <p>Non justifiés : 00,00,00</p>
                                        </div>
                                        <div id="Total_r">
                                            <p>Total : <?php echo $retard;?></p>
                                        </div>
                    ...
                    <!-- <script charset="utf-8"
                        src="js/releveRetardsEtudiant.js"></script> -->
