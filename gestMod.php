<?php
    ...
    include_once "php/conn.php";
        $sql1 = "SELECT distinct md.id_module, md.nom, md.id_promotion, md.ref, md.descr, pr.ref as promo FROM Module md, Promotion pr WHERE md.id_promotion = pr.id_promotion;";
        ...
        while($row1 = $result1->fetch_assoc()){
            ...
            $lignesHTML .= "<tr>
                                ...
                                <td><span class='editable' id='ref-$id'>$ref</span></td>
                                <td><span class='editable' id='promo-$id'>$promo</span></td>
                                <td><span class='editable' id='desc-$id'>$desc</span></td>
                                <td>
                                    <form method='post'>
                                        <button type='submit' class='btn-edit' style='background: none; border: none; padding: 0; color: #d9534f;' name='edit' value='$id' onclick='toggleForm(event, $id, $idpromo)'>
        ...
        if (isset($_POST['Ajouter'])) {
            $nom = $_POST['nomMod'];
            $ref = $_POST['refMod'];
            $promo = $_POST['promoMod'];
            $desc = $_POST['descMod'];
            $idd = $_POST['IDm'];
            $idpp = $_POST['IDp'];
        
            $sql4 = "SELECT id_promotion FROM Promotion WHERE ref='$promo';";
            $result4 = $conn->query($sql4);
            $row4 = $result4->fetch_assoc();
            $promotionID = $row4['id_promotion'];
            // echo "INSERT INTO Personne (nom, prenom, type, adresse, tele1) VALUES('$nom', '$prenom', 'Etudiant', '$adresse', '$tele1');";
            $sql3 = "INSERT INTO Module (nom, ref, id_promotion, descr) VALUES('$nom', '$ref', $promotionID, '$descr');";
        ...
        if (isset($_POST['modifier'])) {
            ...
            // var_dump($_POST);
            $sql2 = "UPDATE Module SET nom='$nom', ref = '$ref', descr = '$desc' WHERE id_module = $idd;";
        ...
        if (isset($_POST['supp'])){
            ...
            $sql5 = "DELETE FROM Personne_Module WHERE id_module=$idd;";
		    ...
		    if( msg == 1 ){
			 ...
			 return false;
                            ...
                            <ul class="breadcrumb push-down-0">
                                ...
                                <li class="active">Gestion des Modules</li>
                            </ul>
                            ...
                            <div class="content-frame">
                                ...
                                <div class="content-frame-top">
                                    <div class="page-title">
                                        <h2><span></span>Gestion des Modules</h2>
                                    </div>
                                ...
                                <div class="row" id="monFormulaire" style="margin-left: 60px; display: none;">
                                    <form method="post"  name="form">
                                        ...
                                        <legend
                                        class="scheduler-border">Modifier Module</legend>
                                            <div>
                                                <table align="center">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <input type="button"
                                                                ...
                                                                value="Rétablir" onclick="getElementById('nomMod').value = '';
                                                                                            getElementById('refMod').value = '';getElementById('promoMod').value = '';
                                                                                            getElementById('descMod').value = ''"/>
                                ...
                                <script>
                                    function toggleForm(event, idm, idp) {
                                        event.preventDefault(); // Empêcher le comportement par défaut du bouton
                                        if (document.getElementById('monFormulaire').style.display == 'none' && idm != -1) {
                                            ...
                                            nom = document.getElementById("nom-" + idm).innerHTML;
                                            ref = document.getElementById("ref-" + idm).innerHTML;
                                            promo = document.getElementById("promo-" + idm).innerHTML;
                                            desc = document.getElementById("desc-" + idm).innerHTML;
                                            ...
                                            document.getElementById("refMod").setAttribute("value", ref);
                                            document.getElementById("promoMod").setAttribute("value", promo);
                                            document.getElementById("descMod").setAttribute("value", desc);
                                            // document.getElementById("telEtud1").setAttribute("value", tele);

                                            document.getElementById("nomMod").setAttribute("placeholder", nom);
                                            document.getElementById("refMod").setAttribute("placeholder", ref);
                                            document.getElementById("promoMod").setAttribute("placeholder", promo);
                                            document.getElementById("descMod").setAttribute("placeholder", desc);
                                        ...
                                        }else if(document.getElementById('monFormulaire').style.display == 'none' && idm == -1){
                                            document.getElementById('monFormulaire').style.display = 'block';
                                            event.preventDefault(); // Empêcher le formulaire d'être soumis
                                            ...
                                            document.getElementById("refMod").setAttribute("value", "");
                                            document.getElementById("promoMod").setAttribute("value", "");
                                            document.getElementById("descMod").setAttribute("value", "");
                                            // document.getElementById("telEtud1").setAttribute("value", tele);

                                            document.getElementById("nomMod").setAttribute("placeholder", "");
                                            document.getElementById("refMod").setAttribute("placeholder", "");
                                            document.getElementById("promoMod").setAttribute("placeholder", "");
                                            document.getElementById("descMod").setAttribute("placeholder", "");
                                            // document.getElementById("telEtud1").setAttribute("placeholder", tele);
                                        }
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <ul class="panel-controls">
                                                <li>
                                                    <form method="post">
                                                        <button type="submit" class="btn-plus" style="background: none; border: none; padding-right: 50px; color: orange;" name="statistique" id="statistique1AP" value="1" onclick="openStatsPage('moduleSTAT.php?promo=1AP', '1AP')">
                                                            <i class="fa fa-eye fa-2x"></i> statistiques 1AP
                                                        </button>
                                                    </form>
                                                </li>
                                                <li>
                                                    <form method="post">
                                                        <button type="submit" class="btn-plus" style="background: none; border: none; padding-right: 50px; color: orange;" name="statistique" id="statistique2AP" value="1" onclick="openStatsPage('moduleSTAT.php?promo=2AP', '2AP')">
                                                            <i class="fa fa-eye fa-2x"></i> statistiques 2AP
                                                        </button>
                                                    </form>
                                                </li>
                                                <li>
                                                    <form method="post">
                                                        <button type="submit" class="btn-plus" style="background: none; border: none; padding-right: 50px; color: orange;" name="statistique" id="statistique1CI" value="1" onclick="openStatsPage('moduleSTAT.php?promo=1CI', '1CI')">
                                                            <i class="fa fa-eye fa-2x"></i> statistiques 1CI
                                                        </button>
                                                    </form>
                                                </li>
                                                <li>
                                                    <form method="post">
                                                        <button type="submit" class="btn-plus" style="background: none; border: none; padding-right: 50px; color: orange;" name="statistique" id="statistique2CI" value="1" onclick="openStatsPage('moduleSTAT.php?promo=2CI', '2CI')">
                                                            <i class="fa fa-eye fa-2x"></i> statistiques 2CI
                                                        </button>
                                                    </form>
                                                </li>
                                                <li>
                                                    <form method="post">
                                                        <button type="submit" class="btn-plus" style="background: none; border: none; padding-right: 50px; color: green;" name="add_person" id="add_person" value="1" onclick="toggleForm(event, -1)">
                                        ...
                                        <script>
                                            function openStatsPage(phpFile, promo) {
